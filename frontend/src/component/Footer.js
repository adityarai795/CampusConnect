...
function Footer() {
  return (
    <>
    <div className=' bottom-0 left-0  justify-around px-4 py-6  md:flex   text-gray-700'>
     ...
     <div className='md:w-1/3  md:text-center my-4 md:my-0'>
      <h3 className='font-bold'>Quick Links</h3>
       <ul className=''>
         ...
         <li className='hover:text-blue-400 cursor-pointer transition-all duration-200 p-1'><span><FontAwesomeIcon icon={faPeopleGroup} /></span>Community</li>
         <li className='hover:text-blue-400 cursor-pointer transition-all duration-200 p-1'><span><FontAwesomeIcon icon={faGamepad} /></span>Jobs</li>
       </ul>
     </div>
     <hr className='md:hidden m-3 w-full' />
