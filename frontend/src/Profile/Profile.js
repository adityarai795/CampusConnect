...
function Profile() {
  const getalldata = async () => {
    try {
      ...
      // You can also set response to state here if needed
    } catch (error) {
  ...
  return (
    ...
    <div className="bg-gray-100 pt-10 px-6">
      ...
      <div className="bg-blue-400 w-full h-60 flex items-end justify-center rounded-lg ">
        <div className="bg-black rounded-full w-40 h-40 border-4 border-white mb-4"></div>
      </div>
      ...
      <form>
        <div className="bg-white  w-full mt-10 p-5 items-end justify-center rounded-lg  shadow-lg">
          ...
          <div className="md:flex md:flex-wrap py-2">
            ...
            <input
              type="text"
              className="border text-black font-bold bg-gray-300 rounded-md p-2 w-full mt-2"
          ...
          <div className="md:flex md:flex-wrap py-2">
            ...
            <input
              type="text"
              className="border text-black font-bold bg-gray-300 rounded-md p-2 w-full mt-2"
              placeholder="adityarai@gmail.com"
            />
          </div>
        ...
        <div className="bg-white  w-full mt-10 p-5 items-end justify-center rounded-lg  shadow-lg">
          ...
          <div className="md:flex md:flex-wrap py-2 ">
            ...
            <input
              type="text"
              className="border text-black font-bold bg-gray-300 rounded-md p-2 w-full mt-2"
              placeholder="https://linkedin.com/in/aman-sharma"
            />
          </div>
        </div>
        <div className="md:flex block md:justify-between md:mb-[100px] mb-[75px] text-center">
          <button
            type="submit"
            className="bg-blue-500 sm:w-[200px] text-white px-4 py-2 rounded-md mt-5"
          >
            Edit Profile
          </button>
          <br />
          <button
            type="reset"
            className="bg-red-500 text-white sm:w-[200px] px-4 py-2 rounded-md mt-5"
          >
            Delete Account
          </button>
        </div>
