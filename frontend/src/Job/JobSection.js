...
const jobs = [
  ...
  return (
    ...
    <h2 className="text-4xl font-bold text-blue-600 text-center mb-2"> Jobs & Internships
</h2>
      <form
      ...
      <JobCardSection title="🎓 Internships" jobs={internships} />
      <JobCardSection title="💼 Jobs" jobs={jobs} />
    </div>
    </div>
  )
}
