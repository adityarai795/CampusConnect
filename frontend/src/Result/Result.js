...
function Result() {
 ...
 <div className="min-h-screen  p-4 flex flex-col items-center justify-start">
  <div className="w-full max-w-5xl bg-white rounded-2xl shadow-xl p-8 mt-[80px]">
    <h1 className="text-4xl font-bold text-blue-500 text-center mb-2">University Result Finder</h1>
    <p className="text-gray-600 text-center mb-6">Quickly access your university results in one click.</p>
