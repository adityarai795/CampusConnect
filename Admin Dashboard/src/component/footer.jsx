  ...
  return (
    ...
    <div className='mt-[100px] bottom-0 left-0  justify-around px-4 py-6  md:flex   text-gray-700'>
     <div className='md:w-1/3 px-3 '>
      <div className='flex items-center'>
                <img src={Logo} alt="Logo" className="h-8 w-8 rounded-full " />
                  <h1  className="text-1xl font-bold p-3  px-3  md:block">CollegeConnect</h1>
        </div>
     ...
     <div className='md:w-1/3'>
      ...
      <span className='hover:text-blue-400 cursor-pointer transition-all duration-200'>Email: info@collegeconnect.com</span>
      <br />
    ...
    <div className='flex md:block justify-between items-center px-3 py-2 w-full text-center'>
        ...
        <p>© 2024 CollegeConnect. All rights reserved.  </p>
